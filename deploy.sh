...
# main config
PLUGINSLUG="display-image-dimensions-in-media-library"
CURRENTDIR=`pwd`
MAINFILE="display-image-dimensions.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/display-image-dimensions-in-media-library" # Remote SVN repo on wordpress.org, with no trailing slash
